...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 25, 2016 at 05:56 PM
...
INSERT INTO `student` (`student_id`, `student_name`, `std_father_name`, `student_address`, `student_phone`, `student_created_date`, `student_created_time`, `student_month`, `student_year`, `student_updated_date`, `student_updated_time`, `student_status`) VALUES
...
INSERT INTO `student_fee` (`student_fee_id`, `student_id`, `class_course_id`, `fee`, `fee_type`, `to_be_pay`, `time`, `date`, `month`, `year`, `status`) VALUES
(1, 1, 1, 12000, 'admission_fee', 12000, '08-08-27', '25-Aug-2016', 'Aug', '2016', 1),
(2, 8, 1, 1200, 'admission_fee', 1200, '08-08-44', '25-Aug-2016', 'Aug', '2016', 1);
...
--
ALTER TABLE `exam`
  MODIFY `e_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;
--
...
--
ALTER TABLE `student_pay_fee`
  MODIFY `studentpay_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `teacher_attendence`
  MODIFY `teacher_att_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=167;
--
